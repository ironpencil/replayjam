...
public class GameObjectShake : MonoBehaviour {
    ...
    public Vector3 gameObjectResetPosition = new Vector3(0, 0, -10);
    ...
    public void Update()
    {
        ...
        if (shakeMagnitude > minimumShake)
        {
            ...
            shakeObject.transform.localPosition = new Vector3(x, y, shakeObject.transform.localPosition.z);

        }
        else
        {
            shakeEnded = true;
            shakeObject.transform.localPosition = gameObjectResetPosition;
        }
